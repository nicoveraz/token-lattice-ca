# Tracker dump -- 2026-07-26T14:23:56Z

| # | state | milestone | labels | title |
|---|---|---|---|---|
| 56 | OPEN | neurips26-submission | paper | Re-check the Limitations lattice-size/model-family sentence after the C20 decision |
...
| 49 | OPEN | neurips26-submission | evidence | Regenerate all figures from results/ at the frozen commit |
| 48 | OPEN | neurips26-submission | blocking,packaging | Assert every number in paper.tex against its results/ file |
| 47 | OPEN | neurips26-submission | paper | paper/NOTES.md cut ledger is stale |
| 46 | OPEN | neurips26-submission | blocking,evidence | logs/n192.log carries the stale pre-F42 verdict and contradicts C13 |
| 45 | OPEN | neurips26-submission | blocking,evidence | Commit or revert the temperature robustness results |
| 44 | OPEN | neurips26-submission | blocking,paper | C20: decide whether the 4-size scale replication enters the body |
...
| 41 | OPEN | - |  | Page fit depends on neurips_2025.sty; the 2026 style is unpublished and can undo the cut |
| 40 | OPEN | - |  | pythia-1b has a non-monotone early lambda dip (step256 = -0.546, below its own step128) — unexplained |
...
| 25 | OPEN | Future work (post-submission) | reproducibility | Phase 1.5 (deferred): hoist duplication; ca.py mutable globals are a real hazard |
...
| 20 | OPEN | Future work (post-submission) | enhancement,significance,methods | Assembly theory as a compositional-complexity read-out of LM/CA generation (branch later; extends #13) |
| 19 | OPEN | Future work (post-submission) | enhancement,significance,methods | New front: activation-lattice information-propagation cone (white-box CA) |
| 18 | CLOSED | - | neurips,writing | Reframe & tighten: drop the capacity claim, own the negative, wire multiplicity (#9) |
| 17 | OPEN | Future work (post-submission) | methods | Greedy (T->0) deterministic rule vs sampled rule: is criticality a sampling phenomenon? |
| 16 | OPEN | Future work (post-submission) | validity,methods | Full-context vs windowed rule: does cross-level agreement improve with rule richness? |
...
| 13 | OPEN | Future work (post-submission) | enhancement,methods | Effective-rule complexity: an algorithmic-complexity axis via CA rule reconstruction (research thread) |
...
| 6 | OPEN | Future work (post-submission) | rigor,validity | P1: Real-model census recovery is near-floor against the wrong corpus |
