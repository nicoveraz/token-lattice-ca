...
$+0.0320\to+0.1686$ at $N{=}96$ ($d{=}1.71$, $p{=}1.3\times10^{-4}$; $n_{\mathrm{pre}}{=}15$,
one run excluded because its damage never ignited, so $\lca$ is undefined for it).
...
\emph{sign} of $\lca$ (6/16 negative at $N{=}48$, 7/15 at $N{=}96$, spanning $-0.216$ to
...
with a doubled lattice ($95\%$ retention) and the plateau levels differ by $-0.0003$ with a
