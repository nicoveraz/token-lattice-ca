#!/usr/bin/env bash
# Build and VERIFY paper 3's arXiv submission tarball.
#
...
#
#   1. THE DRAFTING NOTES BLOCK. main.tex opens with 22 lines addressed to whoever is writing it --
#      the kill conditions from the prior-art gate, the word E3 may never use, an instruction not to
#      reinstate a framing that misdescribed our own data. arXiv distributes source. That block is
...
# `% F178, results/...` source comments live below \documentclass and are NOT touched -- they are
